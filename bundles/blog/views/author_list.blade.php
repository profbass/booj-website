			...
			@foreach($authors as $author)
				<div class="post-author-section shadow-box white-box margin-bottom-30">
					...
					<h2 class="font-30">
						...
						<? if (!empty($author->user_metadata->facebook_id)) echo '<a href="' . $action_urls['facebook'] . $author->user_metadata->facebook_id . '" rel="nofollow" target="_blank" title="My Facebook Page"><i class="glyphicon glyphicon-red-facebook margin-top-5">Facebook</i></a>'; ?>
						<? if (!empty($author->user_metadata->google_plus_id)) echo '<a href="' . $action_urls['google_plus'] . $author->user_metadata->google_plus_id . '" rel="nofollow" target="_blank" title="My Google Plus Page"><i class="glyphicon glyphicon-red-google-plus margin-top-5">Google Plus</i></a>'; ?>
						<? if (!empty($author->user_metadata->twitter_handle)) echo '<a href="' . $action_urls['twitter'] . $author->user_metadata->twitter_handle . '" rel="nofollow" target="_blank" title="My Twitter Page"><i class="glyphicon glyphicon-red-twitter margin-top-5">Twitter</i></a>'; ?>
					</h2>
