        ...
        <?=Form::open($controller_alias . '/save/' . $tag->id, null, array('class' => 'form-horizontal')); ?>
            <fieldset>
                ...
                <div class="control-group{{ isset($errors) && $errors->has('title') ? ' error' : '' }}">
                    ...
                    <div class="controls">
                        <?=Form::text('title', Input::old('title') ? Input::old('title') : $tag->title, array('class' => 'col-xs-6', 'required' => 'required', 'placeholder' => 'Enter Title')); ?>
                ...
                <div class="control-group{{ isset($errors) && $errors->has('slug') ? ' error' : '' }}">
                    ...
                    <div class="controls">
                        <?=Form::text('slug', Input::old('slug') ? Input::old('slug') : $tag->slug, array('class' => 'col-xs-6', 'required' => 'required', 'placeholder' => 'Enter Slug')); ?>
